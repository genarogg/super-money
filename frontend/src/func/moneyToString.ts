...
// pero:
// "un millón doscientos mil Bolívares"
...
const moneyToString = (
    ...
    try {
        ...
        const conectorMoneda =
            requiereDeTrasMillones(entero)
                ? 'de '
                : '';
        ...
        const resultado =
            `${signo}${textoEntero} ${conectorMoneda}${textoMoneda} con ${textoDecimales} ${textoCentimos}`;
